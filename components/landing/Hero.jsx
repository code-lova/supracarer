  ...
  return (
    <div className="relative w-full h-[400px] lg:h-[600px]">
        ...
        <div className="absolute inset-0 flex items-center justify-start p-4 lg:p-8 z-10">
            <div className="p-2 rounded-lg w-[350px] md:w-[600px] lg:w-[700px]">
                ...
                <p className="mt-4 text-base lg:text-xl w-[250px] xl:text-2xl md:w-[400px] xl:w-[610px] text-black font-thin tracking-widest">

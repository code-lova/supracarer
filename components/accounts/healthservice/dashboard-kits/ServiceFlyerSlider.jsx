...
import { serviceFlyerRequest } from "@service/request/healthworker/serviceFlyer";
...
const ServiceFlyerSlider = () => {
  ...
  const {
    ...
    queryKey: ["healthServiceFlyers"],
    queryFn: serviceFlyerRequest.getHealthServiceFlyers,
    ...
    >
      ...
      {flyers[currentIndex] && (
        <div className="px-4 py-4 border-t border-gray-100">
          <h4 className="font-semibold text-tranquil-teal text-sm sm:text-base line-clamp-1">
